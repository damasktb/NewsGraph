...
\dirtree{%
.2 \textcolor{purple}{{requirements.txt}}.
...
Specify one or more newsfeeds in \texttt{newsgraph.py:36}. Optionally, specify the lists \textit{interests} and \textit{ignore}. Run NewsGraph with:

\hspace{1cm}\mintinline{bash}{$ python newsgraph.py}

When the script terminates, the self-contained file \texttt{ng.html} in the \texttt{src} directory will contain the metro map and all its associated data.
