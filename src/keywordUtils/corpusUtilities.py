...
def tokenize(doc, knowledge=True, ltze=False):
  """
  Tokenise the article, extract and disambiguate its named entities.
  """
...
def parseHTML(article):
  """
  Get cleaned article text and meta discription from url
  """
...
def preprocess(doc):
  """
  Sentence tokenise then word tokenise an article
  """
